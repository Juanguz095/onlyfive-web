...
export interface ApiPortafolioPortafolio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    es_publico: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    >;
    slug_compartible: Attribute.UID<'api::portafolio.portafolio', 'titulo'>;
...
export interface ApiPublicacionPublicacion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    portafolios: Attribute.Relation<
      ...
      'api::portafolio.portafolio'
    >;
    taller: Attribute.String;
    tipo: Attribute.Enumeration<['PROYECTOS', 'TALLERES', 'EVENTOS']> &
      Attribute.DefaultTo<'PROYECTOS'>;
    titulo: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::publicacion.publicacion',
